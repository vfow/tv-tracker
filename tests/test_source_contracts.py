...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_real_protected_page_routes_exist(self):
        ...
        self.assertIn('@app.get("/app/network/<int:network_id>", strict_slashes=False)', app_py)
        ...
        self.assertIn('@app.get("/app/theme/<int:theme_id>", strict_slashes=False)', app_py)
        self.assertIn('@app.get("/app/<person_role>/<int:person_id>", strict_slashes=False)', app_py)
