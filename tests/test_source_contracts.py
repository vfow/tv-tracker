...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_phase6_movie_page_profile_and_navigation_repairs_exist(self):
        ...
        self.assertIn('FAVORITE MOVIES', self.read('static/js/profile-vue-bridge.js'))
    ...
    def test_global_real_links_and_movie_favorite_sync_exist(self):
        ...
        self.assertIn('class="profile-favorite-slot filled" :href="slot.route"', self.read('frontend/src/profile/ProfileSurface.vue'))
