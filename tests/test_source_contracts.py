...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_phase66_tmdb_collections_exist(self):
        app_py = self.read('app.py')
        app_js = self.read('static/js/app.js')
        ui = self.read('static/js/ui.js')
        router = self.read('static/js/app-router.js')
        ...
        self.assertIn('TMDB_COLLECTION_EXPORT_PREFIX = "collection_ids"', app_py)
        self.assertIn('def fetch_tmdb_collection_export_ids', app_py)
        self.assertIn('def get_tmdb_collection_index_payload', app_py)
        self.assertIn('@app.get("/api/tmdb/collections")', app_py)
        self.assertIn('@app.get("/api/tmdb/collections/<int:collection_id>")', app_py)
        self.assertIn('@app.get("/app/collection/<collection_key>"', app_py)
        self.assertIn('@app.get("/app/collections"', app_py)
        self.assertIn('function tmdbGetCollectionsIndex', app_js)
        self.assertIn('function openCollectionsPage', app_js)
        self.assertIn('function openCollectionDetailPage', app_js)
        self.assertIn('function getCollectionFilteredMovies', app_js)
        self.assertIn('There are no movies in this collection released in ${state.year}', ui)
        self.assertIn('function renderDiscoverCollectionsSection', ui)
        self.assertIn('function renderCollectionsIndexPage', ui)
        self.assertIn('function renderCollectionDetailPage', ui)
        self.assertIn('Collection Order', ui)
        self.assertIn('Most Popular', ui)
        self.assertIn('Highest Rated', ui)
        self.assertIn('collections-index', router)
        self.assertIn('collection-detail', router)
        self.assertIn('.collection-poster-stack', source_css)
        self.assertIn('.collection-poster-stack', built_css)
    ...
    def test_phase_63c_unified_discover_browse_exists(self):
        ...
        self.assertIn('["title-desc","Title — Z to A"]', ui)
