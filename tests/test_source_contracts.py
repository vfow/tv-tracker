...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_phase_63c_unified_discover_browse_exists(self):
        ...
        self.assertIn('YEAR <span', ui)
        self.assertIn('GENRE <span', ui)
        self.assertIn('COUNTRY <span', ui)
        self.assertIn('LANGUAGE <span', ui)
        self.assertIn('OTHER <span', ui)
        self.assertIn('SORT ${sortSummary', ui)
