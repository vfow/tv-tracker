...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_phase_63c_unified_discover_browse_exists(self):
        ...
        self.assertIn('Search companies', ui)
        ...
        self.assertIn('Title — Z to A', ui)
        self.assertIn('const currentYear = new Date().getFullYear();', ui)
        self.assertIn('for(let decade=currentDecade; decade>=1870; decade-=10)', ui)
        self.assertIn('data-browse-decade=', ui)
        self.assertIn('data-browse-decade-panel=', ui)
