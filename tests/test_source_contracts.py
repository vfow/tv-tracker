...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_real_protected_page_routes_exist(self):
        ...
        v2_router = self.read('static/js/v2-router.js')
        self.assertIn('Deprecated compatibility handle. All routing lives in app-router.js.', v2_router)
        self.assertNotIn('/app/watchlist', v2_router)
    ...
    def test_phase_63b_media_routes_and_country_filtering_exist(self):
        ...
        self.assertIn('getPersonDetailRoute(movieRole,pageState.personId,personRouteLabel,"movie")', ui)
