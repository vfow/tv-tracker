...
class TMDBOnlyContractTests(unittest.TestCase):
    ...
    def test_phase53_genre_media_upgrade_exists(self):
        ...
        self.assertIn('openGenrePage(params.slug,{fromRoute:true,media:params.media})', router)
    ...
    def test_phase_63b_media_routes_and_country_filtering_exist(self):
        ...
        self.assertIn('params.with_origin_country = cleanValue.toUpperCase();', app)
        self.assertNotIn('params.region = cleanValue.toUpperCase();', app)
    ...
    def test_global_real_links_and_movie_favorite_sync_exist(self):
        ...
        self.assertIn('class="genre-media-switch-button ${active ? "active" : ""}"', ui)
